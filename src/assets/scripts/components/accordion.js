...
export default class Accordion {
  constructor(element, options) {
    ...
    // １つ目だけ開ける <div class="c-accordion js-accordion" data-open="1">
    if(element.hasAttribute('data-open')) {
      const openElementNum = element.getAttribute('data-open');
      this.toggleItem(openElementNum - 1, true, { noTransition: true });
    }
